...
//  GrapeCI
//
//  Created by Ricardo.Maqueda on 03/05/2020.
//  Copyright © 2020 Ricardo Maqueda Martinez. All rights reserved.
//
// Read: http://abizern.org/2019/09/29/zip-a-collection-of-publishers.html
...
/// A `Publisher`
/// that combines an array of publishers to provide an output of an array of the `Zip` of their respective outputs.
...
///
/// The failure of any publisher causes a failure of this publisher. When all the publishers complete successfully,
/// this publsher completes successfully
